  ...
  actions: {
        ...
        setTimeout(() => {
          resolve(
            [
              ...
              { id: 11, date: '1.1.2022', category: 'one', value: 1 },
              { id: 12, date: '2.2.2022', category: 'two', value: 2 },
              { id: 13, date: '3.3.2022', category: 'three', value: 3 },
              { id: 14, date: '4.4.2022', category: 'four', value: 4 },
              { id: 15, date: '5.5.2022', category: 'five', value: 5 },
              { id: 16, date: '6.6.2022', category: 'six', value: 6 },
              { id: 17, date: '7.7.2022', category: 'seven', value: 7 },
              { id: 18, date: '8.8.2022', category: 'eight', value: 8 },
              { id: 19, date: '9.9.2022', category: 'nine', value: 9 },
              { id: 20, date: '10.10.2022', category: 'ten', value: 10 },
            ]
          )
        }, 1000)
      })
    ...
    loadCategories({ commit }) {
      return new Promise((resolve) => {
        ...
        .then((list) => commit('setCategories', list))
    },
  },
  modules: {
  }
